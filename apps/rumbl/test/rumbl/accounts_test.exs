defmodule Rumbl.AccountsTest do
  ...
  # Account registration context tests
  describe "register_user/1" do
    ...
    test "requires password to be at least 6 chars long" do
      ...
      assert %{password: ["should be at least 6 character(s)"]} =
         errors_on(changeset)
      # we use the errors_on function defined on Rumbl.DataCase.
      # errors_on is convenient for quickly retrieving errors from the changeset.
      assert Accounts.list_users() == []
    end
  end
